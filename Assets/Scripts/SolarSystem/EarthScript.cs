...
public class EarthScript : MonoBehaviour    
{
    ...
    private float UniverseTimeScale = 1f;
    ...
    private void Start()
    {
        ...
        if (MoonSceneManager.instance != null)
        {
            UniverseTimeScale = MoonSceneManager.instance.universalTimeScale;
        }
    }

    void Update()
    {
        earthAxis.transform.rotation *= Quaternion.Euler(0, (rotationPerDay * Time.deltaTime / (3600 * dayPeriodInHours)) * UniverseTimeScale, 0);
    }
}
